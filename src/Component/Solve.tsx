        ...
        return (
            <div className='wrap'>
                <div className='header'>
                    <h1>Задание</h1>
                    <button title="прервать выполнение текущего задания и настроить новое" onClick={this.props.openConfiguration}>
                        <svg className={css.options_btn + ' header_btn'} xmlns="http://www.w3.org/2000/svg" width="30.548" height="30.548" viewBox="0 0 30.548 30.548">
                            <g id="settings" transform="translate(0 0)">
                                ...
                                <path id="Контур_7" data-name="Контур 7" d="M151.247,157.893a6.647,6.647,0,1,1,6.647-6.647A6.654,6.654,0,0,1,151.247,157.893Zm0-11.5a4.857,4.857,0,1,0,4.857,4.857A4.862,4.862,0,0,0,151.247,146.39Z" transform="translate(-135.972 -135.972)" fill="#395273"/>
                            </g>
                        </svg>
                    </button>
                </div>
